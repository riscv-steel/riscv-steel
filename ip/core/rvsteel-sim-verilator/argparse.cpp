...
//    "--ecall            Exit if there is an instruction ecall\n"
    ...
    "\n\n"
    "Example:\n"
    "rvsteel_sim_verilator --ram-init-h32=add-01.hex --ram-dump-h32=add-01-dump.hex"
    "rvsteel_sim_verilator --out-wave=wave.vcd --ram-init-h32=add-01.hex --ram-dump-h32=add-01-dump.hex"
    "rvsteel_sim_verilator --ram-init-h32=main.hex --host-out=0x4"
    ;
